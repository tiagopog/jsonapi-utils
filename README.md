...
`JSONAPI::Utils` (JU) is built on top of [JSONAPI::Resources](https://github.com/cerebris/jsonapi-resources) taking advantage of its resource-driven style bringing an easy way to build modern JSON APIs with no or less learning curve.
